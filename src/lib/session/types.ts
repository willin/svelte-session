 ...
 * @protected
 */
export interface AdapterOptions<Data = SessionData, FlashData = Data> {
	/**
	 ...
	 */
	strategy?: Constructable<SessionStorageStrategy<Data, FlashData>>;
	/**
...
export interface SessionStorageOptions<Data = SessionData, FlashData = Data> {
