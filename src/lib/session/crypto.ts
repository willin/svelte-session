/**
 * @private Sign a value using a secret.
 * @param {string} value  - The value to sign.
 * @param {string} secret - The secret to use to sign the value.
 * @returns A promise that resolves to the signed value.
 */
export type SignFunction = (value: string, secret: string) => Promise<string>;

/**
 * @private Unsign a value using a secret.
 * @param {string} cookie  - The value to unsign.
 * @param {string} secret - The secret to use to unsign the value.
 * @returns A promise that resolves to the unsigned value or `false` if the
 */
